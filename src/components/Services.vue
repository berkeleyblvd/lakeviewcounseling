...
<div class="bg-white">
  <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
    <div>
      <h2 class="text-lg font-semibold text-indigo-600">Services</h2>
      <p class="mt-2 text-3xl tracking-tight font-bold text-gray-900">Individual Therapy</p>
      <p class="mt-4 text-lg text-gray-500">A personalized approach to treatment that will meet your specific needs.</p>
    </div>
      ...
      <dl class="space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:grid-rows-5 sm:grid-flow-col sm:gap-x-6 sm:gap-y-10 lg:gap-x-8">
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Children (10 and up)</p>
          </dt>
        </div>
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Adolescents</p>
          </dt>
        </div>
        ...
        <div class="relative">
          <dt>
            ...
            <p class="ml-9 text-lg leading-6 font-medium text-gray-900">Adults</p>
          </dt>
        </div>
