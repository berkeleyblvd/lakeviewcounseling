          ...
          <div class="py-8 px-6 text-left bg-gray-50 lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-left lg:p-12">
            ...
            <div class="mt-6">
              <div class="rounded-md shadow">
                <a href="mailto:jackie@lakeviewcounselingllc.com" class="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-800 hover:bg-gray-900"> Email Me </a>
              </div>
            </div>
          </div>
        </div>
