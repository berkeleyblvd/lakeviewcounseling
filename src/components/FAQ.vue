    ...
    <div class="mt-20">
      <dl class="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-10">
        <div>
          ...
          <dd class="mt-3 text-gray-600">This depends on you and your goals. Typically, the average amount is 8-12 sessions, but
          sometimes I see clients for fewer sessions or for years.</dd>
        </div>

        <div>
          <dt class="font-semibold text-gray">Do you provide in person or virtual consultations?</dt>
